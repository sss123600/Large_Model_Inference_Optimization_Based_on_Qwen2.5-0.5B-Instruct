...
*项目实际路径(学生包）：`D:\ecnu_ss\student_release`*
*模型实际路径：`D:\local_model\qwen2.5-0.5b-instruct`*

进入学生包(*路径`D:\ecnu_ss\student_release`*)：
...
且检查严格，注意不要触发`Strict validation failed: benchmark-specific string literal is forbidden: 'hidden_'`
